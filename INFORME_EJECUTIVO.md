# INFORME EJECUTIVO
## Plataforma Digital "Polar en el Campo"
### Estado del proyecto, valor de negocio, camino al MVP y cruxes a resolver

| | |
|---|---|
| **Producto** | Polar en el Campo — Agri-Platform |
...
La plataforma "Polar en el Campo" cumple los objetivos planteados al inicio del proyecto a nivel de prototipo:
